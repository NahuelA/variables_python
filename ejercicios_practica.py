...
def ej2():
    ...
    # print(....)
    print("Los números ingresados fueron:",numero_1,"y",numero_2)
    print("")
    ...
    # Suma
    operacion = numero_1 + numero_2
    print("El resultado de suma",numero_1,"y",numero_2,"es",operacion)
    print("")
    # Resta
    operacion = numero_1 - numero_2
    print("El resultado de restar",numero_1,"y",numero_2,"es",operacion)
    print("")
    # División
    operacion = numero_1 / numero_2
    print("El resultado de dividir",numero_1,"y",numero_2,"es",operacion)
    print("")
    # Multiplicación
    operacion = numero_1 * numero_2
    print("El resultado de multiplicar",numero_1,"y",numero_2,"es",operacion)
    print("")
    #realizado
...
def ej3():
    ...
    # nombre_completo = .....
    nombreCompleto = len(nombre)+len(apellido)
    # Imprimir la cantidad de letras que posee su nombre completo
    print("El total de letras que contiene mi nombre completo es:",nombreCompleto)
    #realizado
...
def ej4():
    ...
    print("El acrónimo de estas palabras es:",acronimo)
    #realizado
...
def ej5():
    ...
    newPalabra = palabra_1[:3]+palabra_2[-3:]
    print("La nueva palabra con los recortes solicitados es:",newPalabra)
    #realizado
